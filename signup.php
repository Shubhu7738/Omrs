      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>Jodi.com</h2>
              <p>Please provide a proper credentials for register the genuin customer.</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Copyright &copy; 2022. All Rights Reserved by Jodi.com</p>
      </div><!-- signin-box -->
